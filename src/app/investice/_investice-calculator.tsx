...
import { trackCitySelected, trackApartmentSizeSelected } from "@/lib/analytics";
...
const initialState: InvesticeCalculatorState = {
  ...
  prispevekRodicu: 0,
  zarizeniNemovitosti: praha1kkDefaults.zarizeniNemovitostiInvestice,
...
export default function InvesticePage() {
  ...
  const handleCitySelect = (city: string) => {
    trackCitySelected(city, 'investice', city !== initialState.selectedCity);
      ...
      if (prev.selectedApartmentSize) {
        ...
        if (apartmentDefaults) {
          Object.assign(updates, {
            ...
            zarizeniNemovitosti: apartmentDefaults.zarizeniNemovitostiInvestice,
  ...
  const handleApartmentSelect = (size: string) => {
    trackApartmentSizeSelected(size, 'investice', size !== initialState.selectedApartmentSize);
