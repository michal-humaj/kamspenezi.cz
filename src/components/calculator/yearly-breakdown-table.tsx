    ...
    <section className="hidden lg:block w-full">
      ...
      <div className="w-full overflow-x-auto px-6">
        <div className="flex justify-center">
          <div className="rounded-[var(--radius-card)] border border-[var(--color-border)] bg-white shadow-[var(--shadow-card)]">
            ...
            <thead>
              ...
              <tr className="border-b border-slate-200">
                <th 
                  rowSpan={2} 
                  className="sticky left-0 top-0 z-50 bg-white px-4 py-3 text-left font-uiSans text-xs font-medium uppercase tracking-wide text-[var(--color-secondary)] border-r border-slate-200"
                ...
                <th 
                  colSpan={8} 
                  className="sticky top-0 z-40 px-4 py-3 text-left font-uiSans text-sm font-semibold text-[var(--color-primary)] border-r-2 border-slate-300 bg-white"
                ...
                <th 
                  colSpan={3} 
                  className="sticky top-0 z-40 px-4 py-3 text-left font-uiSans text-sm font-semibold text-[var(--color-primary)] bg-white"
              ...
              <tr className="border-b-2 border-slate-200">
                {/* Scenario A Columns */}
                <th 
                  className="sticky top-[53px] z-40 px-4 py-3 text-right font-uiSans text-xs font-medium uppercase tracking-wide text-[var(--color-secondary)] bg-white"
                ...
                <th 
                  className="sticky top-[53px] z-40 px-4 py-3 text-right font-uiSans text-xs font-medium uppercase tracking-wide text-[var(--color-primary)] border-r-2 border-slate-300 bg-white"
                ...
                {/* Scenario B Columns */}
                <th 
                  className="sticky top-[53px] z-40 px-4 py-3 text-right font-uiSans text-xs font-medium uppercase tracking-wide text-[var(--color-primary)] bg-white"
